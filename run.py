...
class Item(db.Model):
    ...
    @staticmethod
    def create_item(name, description, price, image_file, author):
        item = Item(name=name, description=description, price=price, author=author, image_file=image_file)
        db.session.add(item)
        db.session.commit()
        return item
...
class User(db.Model, UserMixin):
    ...
    def check_password(self, password):
        ...
        return bcrypt.check_password_hash(str(self.password_hash), password)
